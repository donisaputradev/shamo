    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form action="/product/{{ $product->id }}/edit" method="post">
            ...
            <label class="block mt-4 text-sm">
                ...
                <input
                    class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray @error('name') border-red-600 @enderror form-input"
                    placeholder="Description product" name="description"
            ...
            <label class="block mt-4 text-sm">
                ...
                <input
                    class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray @error('name') border-red-600 @enderror form-input"
                    placeholder="Tags product" name="tags" value="{{ old('tags', $product->tags) }}" />
                @error('tags')
                    <span class="text-xs text-red-600 dark:text-red-400">
                        {{ $message }}
                    </span>
            ...
            <label class="block mt-4 text-sm">
                ...
                <input
                    class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray @error('name') border-red-600 @enderror form-input"
                    placeholder="Price product" type="number" name="price" value="{{ old('price', $product->price) }}" />
                @error('price')
                    <span class="text-xs text-red-600 dark:text-red-400">
                        {{ $message }}
                    </span>
