...
@section('body')
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
                    ...
                    @if ($galleries->isNotEmpty())
                        @foreach ($galleries as $item)
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <div class="relative hidden mr-3 rounded md:block" style="height: 64px; width: 64px">
                                        <img class="object-cover w-full h-full rounded"
                                            src="{{ asset('storage/' . $item->url) }}" alt="" loading="lazy" />
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                            aria-label="Edit" href="/gallery/{{ $item->id }}/edit">
                                        ...
                                        <form action="/gallery/{{ $item->id }}/delete" method="post">
                                            @csrf
                                            @method('delete')
                                            <button
        ...
        @if ($galleries->isNotEmpty() && $galleries->hasPages())
            <div
